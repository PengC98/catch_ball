...
lower=np.array([0,45,46])
upper=np.array([8,250,255])
class img_transform:
    def __init__(self):
...
if __name__ == '__main__':
    IMAGE_PATHS = ["catkin_ws/src/img_trans/src/1.jpg", "2.jpg", "3.jpg"]
    rospy.init_node('image_trans',anonymous=True)
    image = cv2.imread("catkin_ws/src/img_trans/src/1.jpg") 
    #cv2.imshow("1",image)
